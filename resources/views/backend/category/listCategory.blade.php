...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="row">
                <div class="col-lg-12">
                    <h1 style="text-align: center" class="page-header">LIST CATEGORY</h1>
                </div>
            </div>
            ...
            @if(Session::has('thongbaothanhcong'))
                <div style="text-align: center"
                     class="alert alert-success">{!! Session::get('thongbaothanhcong') !!}</div>
            @endif
                            ...
                            <table class="table">
                                ...
                                @foreach($data as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a CLASS="glyphicon glyphicon-trash" href="javascript:void(0)"
                                               onclick="deletecate({!! $value->id !!})"></a>
                                            <a href="{!! route('getSuacate',['id'=>$value->id]) !!}"
